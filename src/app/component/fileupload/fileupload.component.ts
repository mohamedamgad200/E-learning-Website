        ...
        .pipe(
          finalize(() => {
            storageRef.getDownloadURL().subscribe((downloadLink) => {
              ...
              this.fileService.saveMetaDataOfFile(
                this.courseId,
    ...
    if (window.confirm('Are you sure you want to delete ' + file.name + '?')) {
      try {
        ...
        const fileId = await this.fileService
          .getFileIdByName(courseId, file.name)
          .toPromise();
        if (!fileId) {
        ...
        // Delete the file
        await this.fileService.deleteFile(courseId, fileId, file.name);
    ...
    try {
      ...
      this.fileService
        ...
        .subscribe((course) => {
          ...
          this.fileService.getAllFiles(this.courseId).subscribe(
            (files) => {
